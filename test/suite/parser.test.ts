...
import { resetConfiguration, setConfiguration } from '../../src/config';
...
suite('Parser Test Suite', () => {
  ...
  runTest(
    'parseFileForFunctions should identify a React component',
    () => {
  ...
  runTest(
    'parseFileForFunctions should identify props in a React component',
    () => {
      mockCode = `function MyComponent(props) {\n  console.log(props);\n return <div>Hello</div>;\n}`;
      const result = parseFileForFunctions(mockCode, doc);
      assert.strictEqual(result.length, 1);
  ...
  runTest(
    'parseFileForFunctions should identify state variables (useState)',
    () => {
  ...
  runTest(
    'parseFileForFunctions should identify refs (useRef)',
    () => {
  ...
  runTest(
    'parseFileForFunctions should identify context (useContext)',
    () => {
  ...
  runTest(
    'parseFileForFunctions should identify reducers (useReducer)',
    () => {
  ...
  runTest(
    'parseFileForFunctions should identify redux context (useSelector)',
    () => {
  ...
  runTest(
    'parseFileForFunctions should identify context (useContext with member expression)',
    () => {
  ...
  runTest(
    'parseFileForFunctions should identify arguments with object destructuring',
    () => {
      mockCode = 'function myFunction({ a, b }) {\n  console.log(a, b);\n}';
      const result = parseFileForFunctions(mockCode, doc);
      assert.strictEqual(result.length, 1);
  ...
  runTest(
    'parseFileForFunctions should identify arguments with array destructuring',
    () => {
      mockCode = 'function myFunction([a, b]) {\n  console.log(a, b);\n}';
      const result = parseFileForFunctions(mockCode, doc);
      assert.strictEqual(result.length, 1);
  ...
  runTest(
    'parseFileForFunctions should identify arguments with default values',
    () => {
  ...
  runTest(
    'parseFileForFunctions should handle nested functions',
    () => {
  ...
  runTest(
    'parseFileForFunctions should filter sensitive keys',
    () => {
  ...
  runTest(
    'parseFileForFunctions should correctly identify insert position with return statement',
    () => {
      mockCode = `function myFunction() {\n  return 1;\n}`;
      const result = parseFileForFunctions(mockCode, doc);
      assert.strictEqual(result.length, 1);
  ...
  runTest(
    'isFunctionNode should identify arrow function in variable declaration',
    () => {
      mockCode = `const myFunction = () => {};`;
      const result = parseFileForFunctions(mockCode, doc);
      assert.strictEqual(result.length, 1);
  ...
  runTest(
    'isFunctionNode should identify function expression in variable declaration',
    () => {
