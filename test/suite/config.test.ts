...
import { getConfiguration, resetConfiguration, setConfiguration } from '../../src/config';
        ...
        return {
          get: (key: string, defaultValue: any) => {
            switch (key) {
              ...
              case 'logFunction':
                return 'console';
              case 'enableClassMethodLogging':
                return false;
              case 'enableHookLogging':
                return false;
              case 'logTag':
                return '// LOG';
              case 'wrapInDevCheck':
                return true;
              case 'enableContextLogging':
                return false;
              case 'enableReduxContextLogging':
                return false;
              case 'customLoggerImportStatement':
                return '';
              case 'sensitiveKeys':
                return ['secret'];
              case 'ignore':
                return [];
              case 'filterUnusedVariables':
                return false;
              case 'enableDuplicatePrevention':
                return false;
              case 'includeLineNumber':
                return false;
